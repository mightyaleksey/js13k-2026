...
type GamepadButton = { pressed: boolean, value: number, ... }
...
type MidiPermissionDescriptor = {| name: 'midi', sysex?: boolean |}

type PushPermissionDescriptor = {| name: 'push', userVisibleOnly?: boolean |}
...
type MIDIOptions = {| sysex: boolean, software: boolean |}

type MIDIMessageEvent$Init = Event$Init & { data: Uint8Array, ... }
...
type MIDIConnectionEvent$Init = Event$Init & { port: MIDIPort, ... }
...
declare type PerformanceMarkOptions = {| detail?: mixed, startTime?: number |}
...
declare type ResizeObserverOptions = { box?: ResizeObserverBoxOptions, ... }
...
type DoubleRange = { max?: number, min?: number, ... }

type LongRange = { max?: number, min?: number, ... }

type ConstrainBooleanParameters = { exact?: boolean, ideal?: boolean, ... }
...
type ConstrainLongRange = { ...LongRange, exact?: number, ideal?: number, ... }
