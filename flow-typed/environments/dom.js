...
declare type FilePropertyBag = { type?: string, lastModified?: number, ... }
...
type PageTransitionEventInit = { ...Event$Init, persisted: boolean, ... }
...
type ClipboardItemOptions = { presentationStyle?: PresentationStyle, ... }
