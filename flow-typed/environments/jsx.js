...
type ReactDOM$HTMLElementJSXIntrinsic = {
  ...
  props: { +[key: string]: any, +children?: React$Node, ... },
  ...
}
...
type ReactDOM$ReactSpecificProps = {|
  children?: React$Node,
  dangerouslySetInnerHTML?: {| __html: ReactDOM$UserVisibleString |},
...
type ReactDOM$colgroupProps = {| ...ReactDOM$HTMLElementProps, span?: ?number |}
...
type ReactDOM$htmlProps = {| ...ReactDOM$HTMLElementProps, manifest?: ?string |}
...
type ReactDOM$mapProps = {| ...ReactDOM$HTMLElementProps, name?: ?string |}
...
type ReactDOM$slotProps = {| ...ReactDOM$HTMLElementProps, name?: ?string |}
...
type ReactDOM$timeProps = {| ...ReactDOM$HTMLElementProps, dateTime?: ?string |}
...
type ReactDOM$CustomSVGProps = {| line_height?: ?(number | string) |}
